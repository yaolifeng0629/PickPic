          ...
          <div className="bg-gray-50 rounded-lg p-6">
            <div className="grid grid-cols-2 gap-6">
              <div>
                ...
                <a href="https://yaolifeng.com" target="_blank" className="text-base text-blue-500 font-medium" rel="noreferrer">dev@yaolifeng.com</a>
              </div>
              <div>
                <div className="text-sm text-gray-500 mb-1">{t('settings.version')}</div>
                <div className="text-base text-gray-900 font-medium">v2.0.0</div>
              </div>
            </div>
          </div>
